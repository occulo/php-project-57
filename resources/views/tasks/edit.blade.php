      ...
      <form action="{{ route('tasks.update', $task) }}" method="post">
        ...
        <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
          <div class="sm:col-span-2">
            ...
            <input type="text" id="name" name="name" value="{{ old('name', $task->name) }}" class="p-4 text-gray-700 dark:text-gray-300 rounded-lg bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 block w-full placeholder-gray-400 dark:placeholder-gray-500 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 dark:text-white transition" placeholder="{{ __('What needs to be done?') }}" required />
