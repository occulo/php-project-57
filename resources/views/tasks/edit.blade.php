        ...
        <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
            ...
            <div class="mt-6 space-y-6">
                <div>
                    ...
                    <x-text-input id="name" name="name" type="text" :value="old('name', $task->name)" class="w-full mt-1"
                        placeholder="{{ __('app.forms.tasks.title_placeholder') }}" required autofocus />
                ...
                <div>
                    ...
                    <x-textarea-input id="description" name="description" class="w-full mt-1"
                        placeholder="{{ __('app.forms.tasks.description_placeholder') }}">{{ old('description', $task->description) }}</x-textarea-input>
